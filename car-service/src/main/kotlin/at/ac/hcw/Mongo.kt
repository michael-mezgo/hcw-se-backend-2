...
import at.ac.hcw.repository.MongoCarRepository
...
val CarServiceKey = AttributeKey<CarService>("CarService")

fun Application.configureMongo() {
    // Connect to your mongo instance
    val mongoDatabase = connectToMongoDB()
    val carRepository = MongoCarRepository(mongoDatabase)
    val carService = CarService(carRepository)
    attributes.put(CarServiceKey, carService)
}
